...
use crate::{
    constants::{HEIGHT, MAX_SCORE, WIDTH},
    digits::draw_digit,
    winner::Winner,
};
...
impl Game {
    ...
    pub fn draw(&self, c: Context, g: &mut WgpuGraphics) {
        ...
        // Score
        draw_digit(self.scores[0], 50.0, 20.0, c, g);
        draw_digit(self.scores[1], WIDTH - 70.0, 20.0, c, g);
    }
}
